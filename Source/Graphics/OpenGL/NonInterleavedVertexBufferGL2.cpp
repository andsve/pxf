...
NonInterleavedVertexBufferGL2::NonInterleavedVertexBufferGL2(VertexBufferLocation _VertexBufferLocation)
	: NonInterleavedVertexBuffer(_VertexBufferLocation)
{

}

NonInterleavedVertexBufferGL2::~NonInterleavedVertexBufferGL2()
{

}


void NonInterleavedVertexBufferGL2::_PreDraw()
{
...
void NonInterleavedVertexBufferGL2::_PostDraw()
{
...
void NonInterleavedVertexBufferGL2::SetData(VertexBufferAttribute _AttribType, unsigned _TypeSize, const void* _Ptr, unsigned _Count, unsigned _Stride)
{
...
bool NonInterleavedVertexBufferGL2::Commit()
{
	return false;
}
