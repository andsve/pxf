...
void QuadBatchGL2::SetColor(float r, float g, float b)
{
...
void QuadBatchGL2::SetColor(Vec3f* c)
{
	SetColor(c->r, c->g, c->b);
}

void QuadBatchGL2::SetAlpha(float a)
{
...
void QuadBatchGL2::RotatePoint(const Math::Vec3f &center, Math::Vec3f &point, float rotation)
{
...
void QuadBatchGL2::Rotate(float angle)
{
...
void QuadBatchGL2::Translate(float x, float y)
{
    /*m_Translation.x += x;
    m_Translation.y += y;*/
...
void QuadBatchGL2::LoadIdentity()
{
...
void QuadBatchGL2::AddCentered(float x, float y, float w, float h, float rotation)
{
